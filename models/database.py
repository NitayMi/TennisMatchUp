        ...
        if not existing_user:
            ...
            # Create demo court if user is an owner
                ...
                court = Court(
                    ...
                    surface='hard',
                    hourly_rate=80.0,
                    description='Beautiful outdoor hard court with great lighting and parking.'
                )
                court.has_lighting = True
                court.has_parking = True
                court.amenities = 'Lighting, Parking, Equipment Rental'
                db.session.add(court)
